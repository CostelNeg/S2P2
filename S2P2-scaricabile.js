...
if(utenteCheEffettuaLAcquisto.isAmbassador  && priceWithDiscount >=100){
  ...
  console.log("Prezzo complessivo di spedizione non inclusa e : "+(priceWithDiscount + shippingCost))
}
else if(!utenteCheEffettuaLAcquisto.isAmbassador && totalShoppingCart >=100){
  console.log("Prezzo complessivo di spedizione  inclusa e : "+totalShoppingCart)
}else if(!utenteCheEffettuaLAcquisto.isAmbassador && totalShoppingCart <=100){
  console.log("Prezzo complessivo di spedizione non inclusa e : "+(totalShoppingCart + shippingCost))
}